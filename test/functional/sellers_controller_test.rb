...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { description: @seller.description, name: @seller.name, priority: @seller.priority }
    end
  ...
  test "should update seller" do
    put :update, id: @seller, seller: { description: @seller.description, name: @seller.name, priority: @seller.priority }
    assert_redirected_to seller_path(assigns(:seller))
  end
